  ...
  return (
    ...
    >
      <div className="laptop:grid-cols-4 grid max-xl:gap-4">
        <div className="laptop:col-span-2 desktop:col-span-3 flex flex-col gap-2">
        ...
        <div className="laptop:col-span-2 desktop:col-span-1 flex items-end justify-end gap-2 max-xl:flex-col max-xl:items-start">
